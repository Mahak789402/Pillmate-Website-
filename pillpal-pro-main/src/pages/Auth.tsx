...
import { Eye, EyeOff, Mail, Lock, User, ArrowRight, Pill } from "lucide-react";
...
const Auth = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{isLogin ? "Log In" : "Sign Up"} | PillMate</title>
        <meta name="description" content="Sign in or create an account to start managing your medications with PillMate." />
      </Helmet>
        ...
        >
          ...
          <div className="glass rounded-3xl p-8 shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button variant="hero" className="w-full h-12 text-base font-semibold" disabled={isLoading}>
                {isLoading ? (
